        ...
        {isLoading ? (
          <div>
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className={`flex items-center gap-4 px-4 py-3 bg-white border-x border-b border-gray-200 animate-pulse ${
                  i === 0 ? 'border-t rounded-t-lg' : ''
                } ${i === 2 ? 'rounded-b-lg' : ''}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-5 w-20 bg-violet-50 rounded" />
                    <div className="h-5 w-20 bg-violet-50 rounded" />
                  </div>
                </div>
